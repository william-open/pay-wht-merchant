...
type SystemAuthAdminAddReq struct {
	...
	PId          uint   `form:"pId" binding:"required,gt=0"`              // 上一级
	...
	MId          uint   `form:"mId" binding:"gt=0"`                       // 商户ID
...
// SystemAuthRoleListReq 角色列表参数
type SystemAuthRoleListReq struct {
	MId uint `form:"mId"` // 商户ID
}
